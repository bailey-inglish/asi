...
ggplot(
  ...
  labs(
    ...
    caption = "Excluding respondents who refused the income question or answered 'Don't know'."
  ) +
  theme(
...
ggplot(age_power_groups) +
  ...
  labs(
    ...
    subtitle = "For the Novemeber 2008 and 2010 general elections",
    x = "Age group (years)",
    y = "Share of Electorate (%)",
    fill = "Age group (years)",
    caption = "For reference: x = Share of Overall Population (%)"
  ) +
  scale_y_continuous(
    breaks = 0:7 * 10
  )
