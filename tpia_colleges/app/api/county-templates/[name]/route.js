...
const COUNTY_TEMPLATE_ROOT_CANDIDATES = [
  path.join(process.cwd(), 'templates', 'county'),
  path.join(process.cwd(), 'tpia_colleges', 'templates', 'county'),
];

async function resolveTemplatePath(templateName) {
  for (const rootDir of COUNTY_TEMPLATE_ROOT_CANDIDATES) {
