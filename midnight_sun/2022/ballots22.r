# File name: ballots22.r
# Project:   midnight_sun
# Purpose:   Converts a massive trove of 2022 JSON files to CSV files, while
...
for (b in batches) {
  ...
  write_csv(cvr, str_c("products/general_election_2022-", b[1], ".csv"))
  rm(cvr)
}
